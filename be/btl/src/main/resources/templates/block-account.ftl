                        ...
                        <table style="background: #ffffff; border: 0px; border-radius: 4px; width: 99.6672%; overflow: hidden;"
                            ...
                            <tr>
                                <td class="" style="padding: 0px; width: 100%;" align="center">
                                    <table style="background: red; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                           cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr>
                                            ...
                                            <td class="tw-card-header"
                                                ...
                                                align="center"><span
                                                        style="font-weight: 600;">Tài khoản đã bị khóa</span></td>
                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Tài khoản của bạn trên hệ thống HaiVN đã bị khóa!</span><br/><br/>
                                                    <span style="font-weight: 400;">Lý do khóa tài khoản: <b>${reason}</b></span>
                                                <div class=""
