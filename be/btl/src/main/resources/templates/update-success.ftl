            ...
            <table style="background: #F7F8FA; border: 0; border-radius: 0;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="" style="width: 600px;" align="center">
                        <p style="padding: 5px 5px 5px; font-size: 13px; margin: 0 0 0px; color: #316fea;"
                           align="right">
                        </p>
                                    ...
                                    <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                        ...
                                        <tr>
                                            ...
                                            <td class="tw-card-header"
                                                ...
                                                align="center"><span
                                                        style="font-weight: 600;">Cấp tài khoản đăng nhập hệ thống</span></td>
                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Cấp tài khoản hệ thống!</span><br/><br/>
                                                    <span style="font-weight: 400;">Dưới đây là thông tin tài khoản đăng nhập:</span>
                                                <table style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                    <tr>
                                                        <td>
                                                            <table class="button mobile-w-full"
                                                                   style="border: 0px; border-radius: 5px; margin: 0px auto; width: 600px; background-color: #ccb435; height: 50px; color: #fff; font-size: 15px;padding: 10px;"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        Bạn có thể chia sẻ đường link sau để giới thiệu người khác:
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    Hãy liên hệ với chúng tôi nếu bạn có câu hỏi cần giải đáp.&nbsp;</p>
                                                <p class="tw-signoff"
                                                   style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    ...
                                                    <br/> Địa chỉ: Tầng 7, Toà nhà Golden Field, 24 Nguyễn Cơ
                                                    Thạch, Mỹ Đình, Nam Từ Liêm, TP.Hà Nội.
                                                    <br/> Điện thoại: (84-24) 73007768
                                                    <br/> Email: info@aamhr.com.vn
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
