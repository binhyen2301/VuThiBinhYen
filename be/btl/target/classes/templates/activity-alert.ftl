                                    ...
                                    <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                        ...
                                        <tr>
                                            ...
                                            <td class="tw-card-header"
                                                ...
                                                align="center"><span
                                                        style="font-weight: 600;">Thông báo</span></td>
                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Đây là thông báo từ hệ thống.</span>
                                                    <br></br><span
                                                            style="font-weight: 400;">Thực hiện: <strong>${action}</strong></span>
                                                    <br></br><span
                                                            style="font-weight: 400;">Nội dung: <strong>${actionContent}</strong></span>
